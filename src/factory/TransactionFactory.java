...
public class TransactionFactory {
    ...
    public static void createTransaction(String type, int id, int userId, int walletId, int categoryId, BigDecimal amount, String description, LocalDate date) {
        if ("Income".equalsIgnoreCase(type)) {
            Income income =  new Income(id, userId, walletId, categoryId, amount, description, date);
            transactions.add(income);
        } else if ("Expense".equalsIgnoreCase(type)) {
            Expense expense =  new Expense(id, userId, walletId, categoryId, amount, description, date);
